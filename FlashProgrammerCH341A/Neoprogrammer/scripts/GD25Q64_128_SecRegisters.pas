...
begin
  ...
  SPIWrite (0, 4, $42, $00, $10, $00);      // write register 1  page 0
  SPIWriteFromEditor(1, 256, 0);
  repeat                                    //Busy
    SPIWrite(0, 1, $05);
    SPIRead(1, 1, sreg);
  until((sreg and 1) <> 1);
  ...
  SPIWrite (1, 1, $06);                     // write enable
  SPIWrite (0, 4, $42, $00, $11, $00);      // write register 1  page 1
  SPIWriteFromEditor(1, 256, 256);
  repeat                                    //Busy
    SPIWrite(0, 1, $05);
    SPIRead(1, 1, sreg);
  until((sreg and 1) <> 1);
  ...
  SPIWrite (1, 1, $06);                     // write enable
  SPIWrite (0, 4, $42, $00, $12, $00);      // write register 1  page 2
  SPIWriteFromEditor(1, 256, 512);
  repeat                                    //Busy
    SPIWrite(0, 1, $05);
    SPIRead(1, 1, sreg);
  until((sreg and 1) <> 1);
  ...
  SPIWrite (1, 1, $06);                     // write enable
  SPIWrite (0, 4, $42, $00, $13, $00);      // write register 1  page 3
  SPIWriteFromEditor(1, 256, 768);
  repeat                                    //Busy
    SPIWrite(0, 1, $05);
    SPIRead(1, 1, sreg);
  until((sreg and 1) <> 1);
...
begin
  ...
  SPIWrite (1, 1, $06);                     // write enable
  SPIWrite (0, 4, $42, $00, $20, $00);      // write register 2  page 0
  SPIWriteFromEditor(1, 256, 0);
  repeat                                    //Busy
    SPIWrite(0, 1, $05);
    SPIRead(1, 1, sreg);
  ...
  SPIWrite (1, 1, $06);                     // write enable
  SPIWrite (0, 4, $42, $00, $21, $00);      // write register 2  page 1
  SPIWriteFromEditor(1, 256, 256);
  repeat                                    //Busy
    SPIWrite(0, 1, $05);
    SPIRead(1, 1, sreg);
  ...
  SPIWrite (1, 1, $06);                     // write enable
  SPIWrite (0, 4, $42, $00, $22, $00);      // write register 2  page 2
  SPIWriteFromEditor(1, 256, 512);
  repeat                                    //Busy
    SPIWrite(0, 1, $05);
    SPIRead(1, 1, sreg);
  ...
  SPIWrite (1, 1, $06);                     // write enable
  SPIWrite (0, 4, $42, $00, $23, $00);      // write register 2  page 3
  SPIWriteFromEditor(1, 256, 768);
  repeat                                    //Busy
    SPIWrite(0, 1, $05);
    SPIRead(1, 1, sreg);
...
begin
  ...
  SPIWrite (1, 1, $06);                     // write enable
  SPIWrite (0, 4, $42, $00, $30, $00);      // write register 3  page 0
  SPIWriteFromEditor(1, 256, 0);
  repeat                                    //Busy
    SPIWrite(0, 1, $05);
    SPIRead(1, 1, sreg);
  ...
  SPIWrite (1, 1, $06);                     // write enable
  SPIWrite (0, 4, $42, $00, $31, $00);      // write register 3  page 1
  SPIWriteFromEditor(1, 256, 256);
  repeat                                    //Busy
    SPIWrite(0, 1, $05);
    SPIRead(1, 1, sreg);
  ...
  SPIWrite (1, 1, $06);                     // write enable
  SPIWrite (0, 4, $42, $00, $32, $00);      // write register 3  page 2
  SPIWriteFromEditor(1, 256, 512);
  repeat                                    //Busy
    SPIWrite(0, 1, $05);
    SPIRead(1, 1, sreg);
  ...
  SPIWrite (1, 1, $06);                     // write enable
  SPIWrite (0, 4, $42, $00, $33, $00);      // write register 3  page 3
  SPIWriteFromEditor(1, 256, 768);
  repeat                                    //Busy
    SPIWrite(0, 1, $05);
    SPIRead(1, 1, sreg);
